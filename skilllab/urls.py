...
urlpatterns = [
    ...
    path("api/autocomplete/courses/", views.skilllab_course_autocomplete, name="skilllab_course_autocomplete"),
    ...
    path("saved-count/", views.SkillLabSavedCountView.as_view(), name="saved_count"),
    path("highlight/save/", views.SkillLabHighlightSaveView.as_view(), name="highlight_save"),
    path("highlight/list/", views.SkillLabHighlightListView.as_view(), name="highlight_list"),
    path("highlight/delete/", views.SkillLabHighlightDeleteView.as_view(), name="highlight_delete"),
    path("note/save/", views.SkillLabNoteSaveView.as_view(), name="note_save"),
    path("note/list/", views.SkillLabNoteListView.as_view(), name="note_list"),
    path("note/delete/", views.SkillLabNoteDeleteView.as_view(), name="note_delete"),
    path("bookmark/save/", views.SkillLabBookmarkSaveView.as_view(), name="bookmark_save"),
    path("bookmark/list/", views.SkillLabBookmarkListView.as_view(), name="bookmark_list"),
    path("bookmark/delete/", views.SkillLabBookmarkDeleteView.as_view(), name="bookmark_delete"),
