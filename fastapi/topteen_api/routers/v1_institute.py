...
from ._common import not_implemented_django, parse_post_flat, parse_remember_me

router = APIRouter()


@router.post("/register/")
async def institute_register(_: Request) -> None:
    not_implemented_django(method="POST", django_path="/api/v1/institute/register/")


@router.post("/login/")
async def institute_login(request: Request):
    data: dict = {}
