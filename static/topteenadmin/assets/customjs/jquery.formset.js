        ...
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            */
            ...
            insertDeleteLink = function(row) {
                ...
                var delButtonHTML = "<div class=\"form-group col-sm-12 col-md-2 text-center mt-2\">"+'<a class="btn btn-danger ' + options.deleteCssClass + '" href="javascript:void(0)">'+ "<i class=\"ft-x\">" + options.deleteText + "</i>"+'</a>'+"</div>";
