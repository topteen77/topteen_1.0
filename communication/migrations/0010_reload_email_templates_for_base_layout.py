...
def reload_email_content_templates(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('communication', '0009_reload_content_only_email_templates'),
    ]

    operations = [
        migrations.RunPython(reload_email_content_templates, noop_reverse),
    ]
