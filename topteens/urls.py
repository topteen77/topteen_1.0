...
urlpatterns = [
    ...
    path('parents/courses/', users_views.ParentCoursesCatalogView.as_view(), name='parents_courses'),
    path('parents/student/<int:student_id>/buy/psychometric/<str:track>/', users_views.ParentStudentBuyPsychometricView.as_view(), name='parents_student_buy_psychometric'),
    ...
    path('parents/videos/', users_views.ParentContentListView.as_view(), {'kind': 'videos'}, name='parents_videos'),
    path('parents/remove/<str:kind>/', users_views.ParentRemoveSavedItemView.as_view(), name='parents_remove_saved'),
    ...
    path('parents/student/<int:student_id>/assessment-report/', users_views.ParentStudentAssessmentReportFragmentView.as_view(), name='parents_student_assessment_report'),
